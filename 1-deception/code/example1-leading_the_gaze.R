###############################################################
# Leading the gaze: Reproducing Figure 2 of Dong etal. (2016) #
###############################################################
...
# Now we start to apply deceptive visualization techniques to suggest a
# change of trend in the data. The following are examples of BAD visualizations,
# e.g. deceptive viz.
