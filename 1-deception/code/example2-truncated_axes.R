###############################################
# Truncated axes: Comparing life expectancies #
###############################################
...
# This is an example of a BAD, a deceptive, visualization.

# West Germany beats the East in terms of life expectancy
ex %>%
